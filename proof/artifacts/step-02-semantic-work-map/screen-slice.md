...
- `intake_queue_command_bar_widget_command_toolbar`: widget `widget_command_toolbar` in region `command_bar`
  ...
  - Events: `primary_action action cap_bulk_assign_incidents`
...
- capabilities: `cap_bulk_assign_incidents`, `cap_change_incident_status`, `cap_list_intake_items`, `cap_view_incident_detail`

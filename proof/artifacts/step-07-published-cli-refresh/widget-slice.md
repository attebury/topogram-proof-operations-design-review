...
- Ready to edit: true
- Human review needed:
  - Realization 'data_grid_android' is 'unsupported'.
  - Behavior 'filtering' is 'unsupported'.
  - Behavior 'keyboard_navigation' is 'unsupported'.
  - Behavior 'selection' is 'unsupported'.
  - Behavior 'sorting' is 'unsupported'.
  - Realization 'data_grid_android' does not declare 'empty' state coverage.
  - Realization 'data_grid_android' does not declare 'error' state coverage.
  - Realization 'data_grid_ios' does not declare 'error' state coverage.
  - ... 7 more
- Change targets:
...
- Gaps: missing_states: 5, behavior_review_items: 8
- Review rows:
  - Realization 'data_grid_android' is 'unsupported'.
  - Behavior 'filtering' is 'unsupported'.
  - Behavior 'keyboard_navigation' is 'unsupported'.
